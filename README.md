...
```
cd existing_repo
git remote add origin https://gitlab.com/doctorx-client-intro-website/narayani.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/doctorx-client-intro-website/narayani/-/settings/integrations)
